...
import { CheckpointRef } from "@liteeditor/contracts";
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "liteeditor-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "LiteEditor",
              GIT_AUTHOR_EMAIL: "liteeditor@users.noreply.github.com",
              GIT_COMMITTER_NAME: "LiteEditor",
              GIT_COMMITTER_EMAIL: "liteeditor@users.noreply.github.com",
            };
            ...
            const message = `liteeditor checkpoint ref=${input.checkpointRef}`;
