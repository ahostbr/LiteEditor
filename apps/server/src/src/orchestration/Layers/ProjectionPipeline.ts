...
function normalizeSessionProviderName(providerName: string | null): "codex" | "claudeAgent" | null {
  if (providerName === "claude" || providerName === "claudeAgent") {
    return "claudeAgent";
  }
  ...
  const applyThreadSessionsProjection: ProjectorDefinition["apply"] = (
    ...
    Effect.gen(function* () {
      ...
      yield* projectionThreadSessionRepository.upsert({
        ...
        providerName: normalizeSessionProviderName(event.payload.session.providerName),
