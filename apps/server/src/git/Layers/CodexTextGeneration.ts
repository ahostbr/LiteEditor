...
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@liteeditor/shared/git";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    const filePath = path.join(tempDir, `liteeditor-${prefix}-${process.pid}-${randomUUID()}.tmp`);
