...
export function registerGitHubHandlers(): void {
  ...
  ipcMain.handle(
    "github:pr-merge",
    async (_e, number: number, method: "squash" | "rebase" | "merge", deleteBranch?: boolean) => {
  ...
  ipcMain.handle(
    "github:issue-create",
    async (_e, title: string, body: string, labels?: string[], assignees?: string[]) => {
