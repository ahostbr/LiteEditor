...
export function WindowLayout({ panels }: WindowLayoutProps) {
  ...
  const handleResizeMouseDown = useCallback(
    (e: React.MouseEvent, panelId: string, direction: "e" | "s" | "se") => {
      e.preventDefault();
      e.stopPropagation();
        ...
        return (
          <div
            ...
            style={{
              ...
              zIndex: ws.zIndex,
              border:
                panel.id === activePanelId ? "1px solid var(--accent)" : "1px solid var(--border)",
            }}
            onMouseDown={() => {
          ...
          >
            <div
              ...
              onMouseDown={(e) => handleWindowMouseDown(e, panel.id)}
            >
              <PanelRenderer
                panel={panel}
