...
export default function Sidebar() {
  ...
  return (
    <>
      {isElectron ? (
        <>
          <SidebarHeader className={`h-8 flex-row items-center gap-1 px-2 py-0 ${isMacPlatform(navigator.platform) ? 'pl-[90px]' : ''}`} style={{ WebkitAppRegion: "no-drag" } as React.CSSProperties}>
