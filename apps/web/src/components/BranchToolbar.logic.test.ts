import type { GitBranch } from "@liteeditor/contracts";
...
describe("resolveDraftEnvModeAfterBranchChange", () => {
  it("switches to local mode when returning from an existing worktree to the main worktree", () => {
    expect(
      resolveDraftEnvModeAfterBranchChange({
        ...
        currentWorktreePath: "/repo/.liteeditor/ProjectData/worktrees/feature-a",
  ...
  it("uses worktree mode when selecting a branch already attached to a worktree", () => {
    expect(
      resolveDraftEnvModeAfterBranchChange({
        nextWorktreePath: "/repo/.liteeditor/ProjectData/worktrees/feature-a",
        currentWorktreePath: null,
...
describe("resolveBranchSelectionTarget", () => {
  it("reuses an existing secondary worktree for the selected branch", () => {
    expect(
      resolveBranchSelectionTarget({
        ...
        activeWorktreePath: "/repo/.liteeditor/ProjectData/worktrees/feature-a",
        branch: {
          isDefault: false,
          worktreePath: "/repo/.liteeditor/ProjectData/worktrees/feature-b",
        },
      }),
    ).toEqual({
      checkoutCwd: "/repo/.liteeditor/ProjectData/worktrees/feature-b",
      nextWorktreePath: "/repo/.liteeditor/ProjectData/worktrees/feature-b",
  ...
  it("keeps checkout in the current worktree for non-default branches", () => {
    expect(
      ...
      checkoutCwd: "/repo/.liteeditor/ProjectData/worktrees/feature-a",
      nextWorktreePath: "/repo/.liteeditor/ProjectData/worktrees/feature-a",
      reuseExistingWorktree: false,
    });
  });
