...
import { type ProviderKind, DEFAULT_GIT_TEXT_GENERATION_MODEL } from "@liteeditor/contracts";
import { getModelOptions, normalizeModelSlug } from "@liteeditor/shared/model";
import {
  getAppModelOptions,
...
function SettingsRouteView() {
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col bg-background text-foreground overflow-hidden overscroll-y-none isolate">
        {isElectron && (
            ...
            <section className="rounded-2xl border border-border bg-card p-5">
              <div className="mb-4">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Choose how LiteEditor looks across the app.
                </p>
              </div>
