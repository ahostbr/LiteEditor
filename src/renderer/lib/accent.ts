...
export function applyAccentToDOM(hex: string): void {
  ...
  root.setProperty('--accent-glow-sm', `0 0 8px hsl(${colors.accentH}, ${colors.accentS}%, ${colors.accentL}%, 0.3)`)
  root.setProperty('--accent-glow-md', `0 0 16px hsl(${colors.accentH}, ${colors.accentS}%, ${colors.accentL}%, 0.25), 0 0 32px hsl(${colors.accentH}, ${colors.accentS}%, ${colors.accentL}%, 0.1)`)
  root.setProperty('--accent-glow-lg', `0 0 24px hsl(${colors.accentH}, ${colors.accentS}%, ${colors.accentL}%, 0.3), 0 0 48px hsl(${colors.accentH}, ${colors.accentS}%, ${colors.accentL}%, 0.12), 0 0 96px hsl(${colors.accentH}, ${colors.accentS}%, ${colors.accentL}%, 0.04)`)
